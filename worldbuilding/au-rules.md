...
- **Is the swap two-way?** Did Yooyeon wake up in Alex's body, or is she simply gone?
- **Does Alex retain all his memories?** Yes — he is fully himself mentally, just in the wrong body.
- **Does he inherit any of Yooyeon's muscle memory?** TBD — if yes, to what degree? (This affects how quickly he can pass as her in physical activities like dance)
- **Can the swap be reversed?** Unknown — and crucially, Alex doesn't know either.
- **Is there a time limit?** Unknown.
- **Does anyone else know the swap happened?** No (at the start).

### What Remains Unexplained (Intentionally)
The story does not explain the swap. It is not a magical system, not a sci-fi device, not a punishment or reward. It simply happened. This ambiguity is load-bearing — resist the urge to explain it.
...
- No fantasy elements beyond the swap itself
- No other characters are aware the world is "an AU"
- Treat the K-pop industry, schedules, relationships, and group dynamics as realistic

---

## Physical & Practical Implications

### Body
- Alex is now in a body with different height, weight, physical conditioning, voice, and appearance
- He must navigate physical activities (dance practice, schedules, fan interactions) with a body he doesn't know
- The body has muscle memory that may conflict with or assist his intentions

### Identity Documents, Phone, etc.
- He has access to Yooyeon's phone, apartment, schedule
- Anyone who contacts "Yooyeon" is contacting him
- He has to decide, immediately, whether to respond as her or not

### Schedule
- tripleS members have managed schedules — he cannot simply disappear
- A manager or member will notice if "Yooyeon" doesn't show up or acts strangely

---

## Social Rules of the Story

- Members do not know about the swap (initially)
- The manager(s) do not know
- Alex's prior life (his apartment, job, social circle) is effectively frozen — nobody knows what happened to the real Alex either

> This document should be updated as story decisions firm up.
