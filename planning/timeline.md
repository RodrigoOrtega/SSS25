...
| Day | Events |
|-----|--------|
| TBD | First group schedule Alex must attend as Yooyeon |
| TBD | Members introduced in clusters |
| TBD | First significant one-on-one with a member |

## Fracture and Reveal (Arc 4)

| Day | Events |
|-----|--------|
| TBD | Inciting incident — something cracks |
| TBD | First member begins to suspect |
| TBD | The reveal (scope and audience TBD) |

## Resolution (Arc 5)

| Day | Events |
|-----|--------|
| TBD | Ongoing — this arc spans weeks or months in-story |

## Endings (Arc 6)

| Branch | Approximate timeline from reveal |
|--------|----------------------------------|
| Bad for Alex | Gradual, no clear endpoint — he fades |
| Bittersweet | Defined moment of resolution, some months out |
| Bad for Yooyeon | Relatively decisive moment — shorter than bittersweet |
| Non-conclusive | Story simply stops — no defined endpoint |

---

> This document will be updated as arcs are drafted and timing becomes clearer.
