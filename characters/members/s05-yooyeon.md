# Character: Yooyeon (김유연) — Member Reference

> This file tracks Yooyeon as a tripleS member within the group context.
> For her role as the body Alex inhabits and her thematic function, see `characters/yooyeon.md`.
...
- **Hyerin:** Not among Yooyeon's closest friends — different circles, limited daily interaction. But something specific operates between them: around Hyerin, Yooyeon loosens. The composure she maintains as the group's anchor does not hold the same way. Hyerin's expressiveness gives Yooyeon permission to be sillier than usual — to try to get the face, to be the Auguste to Hyerin's Whiteface in a way she doesn't get to be elsewhere. The relationship has no deep emotional intimacy, but it has a reliable texture. Yooyeon trusts Hyerin with tasks — delegates to her, defers to her competence. She does not bring her personal concerns here; this is functional trust, not confessional closeness.
- **Kotone:** Friends. TBD — establish depth and texture when Kotone's profile is developed.
- **Nakyoung:** Friends. TBD — establish depth and texture when Nakyoung's profile is developed.
- **Soomin:** Friends. TBD — establish depth and texture when Soomin's profile is developed.

---

## TO CONTINUE

- The relationships with Kotone, Nakyoung, and Soomin are noted as friendships but have no texture yet. These need to be developed — particularly because they determine which members have the most intimate reference point for "Yooyeon" after the swap, and will therefore be among the first to sense something is wrong.
- Yooyeon's broader personality, public image, and private world are all in `characters/yooyeon.md` and remain largely TBD.
...
- **Group context (Day 0):** S5; participated in ASSEMBLE24 (May 2024), promotions recently wrapped. AAA unit member. EVOLution unit member. Visionary Vision member — Gravity not yet announced as of Day 0. Sun orbital unit.
- **Emotional state:** —
- **What she knows:** —
